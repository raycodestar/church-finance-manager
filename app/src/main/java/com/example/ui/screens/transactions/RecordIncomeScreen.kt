...
fun RecordIncomeScreen(
    ...
    var selectedGatheringName by remember { mutableStateOf(presetGatheringName ?: "None (General Collection)") }
    var gatheringExpanded by remember { mutableStateOf(false) }

    val defaultCategory = incomeCategories.firstOrNull()
    ...
    Scaffold(
        ...
        Column(
            ...
            Text(
                text = "Record Church Collection",
                style = MaterialTheme.typography.titleLarge.copy(fontWeight = FontWeight.Bold)
            )
            Text(
                text = "Record Tithes, Offertory, Building Fund, or Donations",
            ...
            ExposedDropdownMenuBox(
                ...
                ExposedDropdownMenu(
                    ...
                    incomeCategories.filter { !it.isDisabled }.forEach { cat ->
                        DropdownMenuItem(
                            text = { Text(cat.name) },
                            onClick = {
            ...
            ExposedDropdownMenuBox(
                ...
                ExposedDropdownMenu(
                    ...
                    DropdownMenuItem(
                        text = { Text("None (General Collection)") },
                        onClick = {
                            selectedGatheringId = null
                            selectedGatheringName = "None (General Collection)"
            ...
            OutlinedTextField(
                ...
                label = { Text("Description or Notes (Optional)") },
                modifier = Modifier.fillMaxWidth()
            )
            ...
            Button(
                onClick = {
                    ...
                    if (category == null) {
                        errorMessage = "Please select an income category."
